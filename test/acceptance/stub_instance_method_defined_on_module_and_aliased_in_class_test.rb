...
class StubInstanceMethodDefinedOnModuleAndAliasedInClassTest < Mocha::TestCase
  ...
  def test_should_stub_public_method_and_leave_it_unchanged_after_test
    ...
    klass = Class.new do
      ...
      class << self
        alias_method  :my_class_method_aliased, :my_class_method
      end
    end
    ...
    assert_equal :original_return_value, klass.my_class_method_aliased
  end
  ...
  def test_should_stub_protected_method_and_leave_it_unchanged_after_test
    ...
    assert_equal :original_return_value, klass.send(:my_class_method_aliased)
  end
